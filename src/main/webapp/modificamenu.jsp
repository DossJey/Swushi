...
<head>
    ...
    <link rel="stylesheet" href="./css/header.style/modificamenu.css" type="text/css">
                    ...
                    <div class = "card maki">
                        ...
                        <div class = "card uramaki">
                            ...
                            <div class = "card gio">
                                ...
                                <form action = "ModificaMenuServlet" method="get">
                                    ...
                                    <button type = "submit" class="add">MODIFICA PREZZO</button>
